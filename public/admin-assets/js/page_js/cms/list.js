$(document).ready(function () {
	var userTable = $("#cms_table").DataTable({
		searchDelay: 500,
		processing: true,
		serverSide: true,
		responsive: true,
				...
				render: function (data, type, full, meta) {
					if (full.status == "0") {
						var action =
							' <a href="' +
							full.edit_url +
							'" class="btn btn-sm btn-icon btn-light-primary btn-active-primary" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="top" title = "Edit CMS">\
							<span class="svg-icon">\
						...
						if (data > 3) {
							action +=
								...
								'"  data-url="' +
								full.destroy_url +
								'"  onClick="destroyFunction(this)" class="btn btn-sm btn-icon btn-light-danger btn-active-danger" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="top" title = "Delete CMS">\
								<span class="svg-icon">\
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">\
					...
					var action =
						' <a href="' +
						full.show_url +
						'" target="_blank" class="btn btn-sm btn-icon btn-light-dark btn-active-dark" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="top" title = "View Details">\
	...
	$("#datatable_cms_search").on("keyup", function (e) {
		userTable.search(e.target.value).draw();
	});
	$("input[type=search]").on("search", function () {
		userTable.search("").draw();
	});
	const documentTitle = "CMS Report";
