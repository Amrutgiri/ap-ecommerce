$(document).ready(function () {
		...
		columnDefs: [
			...
			},
			{
				...
				render: function (data, type, full, meta) {
					...
					return (
						'<a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="top" title = "View Details" onclick="detailsModal(this);"  data-id="'+data+'" class="btn btn-sm btn-icon btn-light-dark btn-active-dark">\
								<span class="svg-icon">\
						...
						'" alt="">\
													...
													<div class="d-flex flex-column">\
														<a class="text-gray-900 fs-6 fw-bold">' +
						full.user_id +
						'</a>\
													</div>\
												</div>\
						...
						data +
						'"  data-url="' +
						full.service_provider_rating_review_destroy_url +
						'" onClick="destroyFunction(this)" class="btn btn-sm btn-icon btn-light-danger btn-active-danger" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="top" title = "Delete Rating">\
							<span class="svg-icon">\
								<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">\
	...
	const documentTitle = "Service Provider Rating-Review Report";
