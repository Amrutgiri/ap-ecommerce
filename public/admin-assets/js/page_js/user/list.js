$(document).ready(function () {
				...
				render: function (data, type, full, meta) {
					if (full.profile_completion == "0") {
						return (
							...
							'" data-url="' +
							full.destroy_url +
							'" onClick="destroyFunction(this)" class="btn btn-sm btn-icon btn-light-danger btn-active-danger" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="top" title = "Delete User">\
										<span class="svg-icon">\
						...
						return (
							...
							'" class="btn btn-sm btn-icon btn-light-dark btn-active-dark" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="top" title = "View Details">\
									...
									<a href="' +
							full.edit_url +
							'" class="btn btn-sm btn-icon btn-light-primary btn-active-primary" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="top" title = "Edit User">\
										<span class="svg-icon">\
											<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">\
	...
	$("#datatable_user_search").on("keyup", function (e) {
	...
	const documentTitle = "User Report";
