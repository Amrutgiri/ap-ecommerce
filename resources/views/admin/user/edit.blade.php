                            ...
                            <div class="image-input image-input-outline @error('profile') is-invalid @enderror"
                                ...
                                @if ($user->profile && Storage::exists($user->profile))
                                    ...
                                    <div class="image-input-wrapper w-125px h-125px"
                                        style="background-image: url({{ Storage::url($user->profile) }})">
                                    </div>
                        ...
                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                            <div class="@error('email') is-invalid @enderror">
                                <input type="text" name="email"
                                    ...
                                    placeholder="Email" value="{{ old('email', $user->email) }}" maxlength="70"
                                    autocomplete="email">
                            </div>
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                            <div class="@error('phone') is-invalid @enderror">
                                ...
                                <input type="tel" name="phone" id="phone"
                                    ...
                                    placeholder="Mobile Number" value="{{ old('phone', $user->phone) }}" maxlength="15">
                            </div>
                            @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="col-lg-8 fv-row">
                            ...
                            <div class="form-group" id="latitudeArea">
                                <input type="hidden" id="latitude" name="latitude"
                                    value="{{ old('latitude', $user->latitude) }}" class="form-control">
                            </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input name="state"
                                ...
                                placeholder="State" id="state" value="{{ old('state', $user->state_id) }}" />
                            @error('state')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input name="city"
                                ...
                                placeholder="City" id="city" value="{{ old('state', $user->city_id) }}" />
                            @error('city')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="row">
                                ...
                                <div class="fv-row fv-plugins-icon-container">
                                    <input type="text" name="zipcode"
                                        ...
                                        placeholder="Zip Code" value="{{ old('zipcode', $user->zipcode) }}"
