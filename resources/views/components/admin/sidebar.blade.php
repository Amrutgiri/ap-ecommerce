<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        ...
        <a href="{{ route('admin.dashboard') }}">
            <img alt="Logo" src="{{ asset('admin-assets/media/logos/Fixr-Upper-Logo-Final-05.png') }}"
                class="h-90px w-160px app-sidebar-logo-default" />
            <img alt="Logo" src="{{ asset('admin-assets/media/logos/Fixr-Upper-Logo-Final-06.png') }}"
    ...
    <div class="app-sidebar-footer flex-column-auto pt-2 pb-6 px-6" id="kt_app_sidebar_footer">
        <a href="javascript:void(0)" onclick="logoutAdmin(); "
            class="btn btn-flex flex-center btn-custom btn-primary overflow-hidden text-nowrap px-0 h-40px w-100 logout">
