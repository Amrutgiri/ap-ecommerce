...
<head>
    ...
    <link href="{{ asset('admin-assets/plugins/global/plugins.bundle.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('admin-assets/css/style.bundle.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('admin-assets/css/custom.css') }}" rel="stylesheet" type="text/css" />
    <!--end::Global Stylesheets Bundle-->
    <script>
        var defaultThemeMode = "custom";
        var themeMode = "light";
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
    ...
    <!--begin::Drawers-->
    <!--begin::Chat drawer-->
    <div id="kt_drawer_chat" class="bg-body mt-0" data-kt-drawer="true" data-kt-drawer-name="chat"
    ...
    <script src="{{ asset('admin-assets/js/scripts.bundle.min.js') }}"></script>

    <!--end::Global Javascript Bundle-->
    <!--begin::Custom Javascript(used by this page)-->
    <script>
        const hostUrl = "{{ config('app.url') }}";
        const socketUrl = "{{ config('app.socket_url') }}";
